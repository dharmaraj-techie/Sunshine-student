...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    // Completed (3) Create a final private ForecastAdapterOnClickHandler called mClickHandler
        private final ForecastAdapterOnClickHandler mAdapterOnClickHandler;
    ...
    public ForecastAdapter(ForecastAdapterOnClickHandler adapterOnClickHandler) {
        mAdapterOnClickHandler = adapterOnClickHandler;
    }
    ...
    public class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            mAdapterOnClickHandler.OnCLickHandler(data);
        }
