...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mErrorMesageTextView = (TextView)findViewById(R.id.tv_error_message);
    ...
    private void loadWeatherData() {
        // Completed (20)  showWeatherDataView before executing the AsyncTask
        showWeatherDataView();
    ...
    public void showWeatherDataView(){
        ...
        mErrorMesageTextView.setVisibility(View.INVISIBLE);
    }
    public void showErrorMessage(){
        mWeatherTextView.setVisibility(View.INVISIBLE);
        mErrorMesageTextView.setVisibility(View.VISIBLE);
    }
